// ERROR messages
export const ERROR_TAXCODE_ALREADY_EXISTS = 'Mã số thuế đã tồn tại';
export const ERROR_EMAIL_ALREADY_EXISTS = 'Email đã tồn tại';
export const ERROR_NAME_ALREADY_EXISTS = 'Tên doanh nghiệp đã tồn tại';
