...
export class InitSchema1748501181885 implements MigrationInterface {
    name = 'InitSchema1748501181885'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_user_type_enum" AS ENUM('ADMIN', 'BUSINESS')`);
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "account" character varying(50) NOT NULL, "password" character varying(255) NOT NULL, "full_name" character varying(100) NOT NULL, "job_title" character varying(100), "gender" "public"."users_gender_enum" NOT NULL, "user_type" "public"."users_user_type_enum" NOT NULL, "birthday" date, "email" character varying(100) NOT NULL, "phone" character varying(15), "business_id" uuid NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "avatar_url" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "role_id" uuid, CONSTRAINT "UQ_dd44b05034165835d6dcc18d684" UNIQUE ("account"), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_a000cca60bcf04454e727699490" UNIQUE ("phone"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
