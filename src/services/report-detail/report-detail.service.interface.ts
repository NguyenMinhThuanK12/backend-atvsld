...
export interface IReportDetailService {
  create(dto: CreateReportDetailRequest): Promise<ApiResponse<ReportDetailResponse>>;
  update(id: string, dto: UpdateReportDetailRequest): Promise<ApiResponse<ReportDetailResponse>>;
